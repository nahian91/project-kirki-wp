        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 col-sm-12">
            <div class="text-wrapper">
              <div>
                <h2 class="title-hl wow fadeInLeft" data-wow-delay="0.3s"><?php echo get_theme_mod('about_heading');?></h2>
                <p class="mb-4"><?php echo get_theme_mod('about_desc');?></p>
                <a href="<?php echo get_theme_mod('about_btn_link');?>" class="btn btn-common"><?php echo get_theme_mod('about_btn_text');?></a>
              </div>
            </div>
          </div>
